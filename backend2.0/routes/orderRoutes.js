...
const permissions = {
  ...
  getOrderItemsBySellerId: [Roles.Admin, Roles.Farmer],
...
router.get(
  "/user/:id",
  authenticateToken(permissions.getOrdersByUserId),
  getOrdersByUserId
);

router.post(
  "/:orderId/items",
  authenticateToken(permissions.createOrderItem),
  createOrderItem
);
router.get(
  "/:orderId/items",
  authenticateToken(permissions.getOrderItemsByOrderId),
  getOrderItemsByOrderId
);
router.put(
  "/items/:id",
  authenticateToken(permissions.updateOrderItem),
  updateOrderItem
);
router.delete(
  "/items/:id",
  authenticateToken(permissions.deleteOrderItem),
  deleteOrderItem
);

router.get(
  "/:sellerId/items/",
  authenticateToken(permissions.getOrderItemsBySellerId),
  getOrderItemsBySellerId
);
router.put(
  "/items/:id/approve",
  authenticateToken(permissions.approveOrderItem),
  approveOrderItem
);
