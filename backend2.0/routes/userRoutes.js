...
router.put("/:id", authenticateToken(permissions.updateUser), updateUser)
router.delete("/:id", authenticateToken(permissions.deleteUser), deleteUser)
router.post("/:userId/events", addUserEvent)
router.delete("/:userId/events/:eventId", authenticateToken(permissions.removeUserEvent), removeUserEvent)
